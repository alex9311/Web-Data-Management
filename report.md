...
Lastly the score that was generated by lilypond should be displayed in the browsor. For this the php function readFile is used, by defining a header and then calling the readFile function the selected score is displayed in the browsor. The code used for conversion and showing the pdf can be found [here](apps/music/test_lily/convert.php).
